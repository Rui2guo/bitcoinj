...
package org.fabcoinj.core;

import org.fabcoinj.core.TransactionConfidence.ConfidenceType;
import org.fabcoinj.crypto.TransactionSignature;
import org.fabcoinj.script.Script;
import org.fabcoinj.script.ScriptBuilder;
import org.fabcoinj.script.ScriptOpCodes;
import org.fabcoinj.signers.TransactionSigner;
import org.fabcoinj.utils.ExchangeRate;
import org.fabcoinj.wallet.Wallet;
import org.fabcoinj.wallet.WalletTransaction.Pool;
...
import static org.fabcoinj.core.Utils.*;
...
public class Transaction extends ChildMessage {
    ...
    private Sha256Hash persentBlockHash;
    ...
    protected void parse() throws ProtocolException {
        ...
        if (version == 12){
            ...
            persentBlockHash =Sha256Hash.wrap("000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f");
        }
    ...
    public String toString(@Nullable AbstractBlockChain chain) {
        ...
        if(persentBlockHash == null)
            s.append("persentBlockHash").append(persentBlockHash).append('\n');
        if (isTimeLocked()) {
    ...
    protected void bitcoinSerializeToStream(OutputStream stream) throws IOException {
        ...
        stream.write(persentBlockHash.getBytes());
    ...
    public Sha256Hash getPersentBlockHash(){ return persentBlockHash;}

    public void setPersentBlockHash(Sha256Hash persentBlockHash){
        this.persentBlockHash =persentBlockHash;
    }
