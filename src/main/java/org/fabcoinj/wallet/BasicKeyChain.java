...
import org.fabcoinj.utils.ListenerRegistration;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.fabcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.fabcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
