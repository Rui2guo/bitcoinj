...
import org.fabcoin.protocols.payments.Protos.*;
import org.fabcoinj.core.listeners.*;
import org.fabcoinj.core.AbstractBlockChain;
import org.fabcoinj.core.Address;
import org.fabcoinj.core.BlockChain;
import org.fabcoinj.core.BloomFilter;
import org.fabcoinj.core.Coin;
import org.fabcoinj.core.Context;
import org.fabcoinj.core.ECKey;
import org.fabcoinj.core.FilteredBlock;
import org.fabcoinj.core.InsufficientMoneyException;
import org.fabcoinj.core.Message;
import org.fabcoinj.core.NetworkParameters;
import org.fabcoinj.core.Peer;
import org.fabcoinj.core.PeerFilterProvider;
import org.fabcoinj.core.PeerGroup;
import org.fabcoinj.core.ScriptException;
import org.fabcoinj.core.Sha256Hash;
import org.fabcoinj.core.StoredBlock;
import org.fabcoinj.core.Transaction;
import org.fabcoinj.core.TransactionBag;
import org.fabcoinj.core.TransactionBroadcast;
import org.fabcoinj.core.TransactionBroadcaster;
import org.fabcoinj.core.TransactionConfidence;
import org.fabcoinj.core.TransactionInput;
import org.fabcoinj.core.TransactionOutPoint;
import org.fabcoinj.core.TransactionOutput;
import org.fabcoinj.core.UTXO;
import org.fabcoinj.core.UTXOProvider;
import org.fabcoinj.core.UTXOProviderException;
import org.fabcoinj.core.Utils;
import org.fabcoinj.core.VarInt;
import org.fabcoinj.core.VerificationException;
import org.fabcoinj.core.TransactionConfidence.*;
import org.fabcoinj.crypto.*;
import org.fabcoinj.script.*;
import org.fabcoinj.signers.*;
import org.fabcoinj.utils.*;
import org.fabcoinj.wallet.Protos.Wallet.*;
import org.fabcoinj.wallet.WalletTransaction.*;
import org.fabcoinj.wallet.listeners.KeyChainEventListener;
import org.fabcoinj.wallet.listeners.ScriptsChangeEventListener;
import org.fabcoinj.wallet.listeners.WalletChangeEventListener;
import org.fabcoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.fabcoinj.wallet.listeners.WalletCoinsSentEventListener;
import org.fabcoinj.wallet.listeners.WalletEventListener;
import org.fabcoinj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.fabcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.fabcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.fabcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.fabcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.fabcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.fabcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.fabcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.fabcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.fabcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.fabcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.fabcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.fabcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.fabcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.fabcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.fabcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.fabcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.fabcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.fabcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.fabcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
     ...
     * of {@link org.fabcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.fabcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.fabcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
